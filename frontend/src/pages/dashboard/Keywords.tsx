...
const Keywords: React.FC = () => {
    ...
    useEffect(() => {
        const fetchSavedKeywords = async () => {
            try {
                ...
                console.error("Failed to retrieve tracked keywords:", err);
            }
        };
        fetchSavedKeywords();
    }, []);
    ...
    const handleAnalyzeSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        const computedPayload = phrases.map((phrase) => ({
            phrase,
        ...
        try {
            ...
            if (axios.isAxiosError(err) && err.response?.data?.message) {
                ...
                setError("Failed to securely save keyword metrics profiles.");
            }
        } finally {
            setLoading(false);
        }
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Analyze target phrases to optimize density ratios and
                        match true search intent.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleAnalyzeSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                placeholder="Enter search keywords separated by commas (e.g., mern stack developer, nextjs seo)"
